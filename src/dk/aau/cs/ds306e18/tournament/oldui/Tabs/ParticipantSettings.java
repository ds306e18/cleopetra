...
import dk.aau.cs.ds306e18.tournament.oldui.FixedTextField;
...
public class ParticipantSettings  extends Tab{
    ...
    private VBox teamsBox(){
        ...
        addBtn.setOnAction(e -> {
            dk.aau.cs.ds306e18.tournament.oldui.Stage tempStage = new dk.aau.cs.ds306e18.tournament.oldui.Stage(id, "Team " + id);
            id += 1;
